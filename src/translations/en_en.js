export default {
  ...
  'manager.table.ban': 'Punish',
  'manager.table.url': 'Channel',
  'manager.table.tochannel': 'visit channel',
  'manager.table.impersonate': 'to panel',
  'manager.no_users.title': 'No streamers live to stalk.',
  'manager.no_users.subtitle': 'You are a part of the Twasi team... go do something important.',
  ...
  'overview.viewercourse.past.subtitle': 'Here you can see the course of the stream.',
  ...
  'overview.played_games.past.subtitle': 'Your played games of the stream.',
  ...
  'overview.chatterchart.subtitle': 'Here you can see the top 30 chatters of your current / last stream.',
  'overview.chatterchart.past.subtitle': 'Here you can see the top 30 chatters of the stream.',
  ...
  'profile.smartlife.connected': 'Manage Smartlife',
  ...
  'themecreator.common.fontcolor': 'Font Color',
  'themecreator.common.borderradius': 'Border Radius',
  'themecreator.common.primarycolor': 'Primary Color',
  'themecreator.common.secondarycolor': 'Secondary Color',
  'themecreator.themestore_button': 'Theme Store',
  'themecreator.darkmode_toggle': 'This theme will be a dark theme',
  'themecreator.enableSnow': 'Enable snow for this theme',
  'themecreator.new.title': 'New Theme',
  'themecreator.new.subtitle': 'Before you start choose a name for your theme.',
  'themecreator.new.name': 'Name of your theme',
  'themecreator.new.content.title': 'Content',
  'themecreator.new.content.subtitle': 'The content area is the background of the page.',
  'themecreator.new.header.title': 'Header',
  'themecreator.new.header.subtitle': 'The header is the upper part of the page.',
  'themecreator.new.header.upload_field': 'Choose image',
  'themecreator.new.logo.title': 'Logo',
  'themecreator.new.logo.subtitle': 'The logo should have a matching color to the theme.',
  'themecreator.new.logo.maincolor': 'Logo Color',
  'themecreator.new.logo.logoborder': 'Border Color',
  'themecreator.new.logo.primaryshadow': 'Primary Shadow Color',
  'themecreator.new.logo.secondaryshadow': 'Secondary Shadow Color',
  'themecreator.new.panels.title': 'Panels',
  'themecreator.new.panels.subtitle': 'The panels are the most used elements of the page.',
  'themecreator.new.cards.title': 'Special content',
  'themecreator.new.cards.subtitle': 'Special contents are highlighted.',
  'themecreator.new.buttons.title': 'Buttons',
  'themecreator.new.buttons.subtitle': 'Buttons are used to refresh and load content..',
  'themecreator.preview.title': 'Preview',
  'themecreator.preview.subtitle': 'Your theme will look like this.',
  'themecreator.preview.savetheme': 'Save theme',
  'themecreator.preview.content.title': 'Page background',
  'themecreator.preview.content.subtitle': 'Your page background will look like this.',
  'themecreator.preview.panels.title': 'Panels',
  'themecreator.preview.panels.subtitle': 'Your panels will look like this.',
  'themecreator.preview.cards.title': 'Special content',
